...
**
** Created: Fri Apr 12 22:03:04 2013
...
static const char qt_meta_stringdata_LoginPage[] = {
    "LoginPage\0\0,,\0sgnalEnterMainPage(QString,QString,int)\0"
    "slotConnectClicked()\0"
};

const QMetaObject LoginPage::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_LoginPage,
...
int LoginPage::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: sgnalEnterMainPage((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        case 1: slotConnectClicked(); break;
        default: ;
        }
        _id -= 2;
    }
...
// SIGNAL 0
void LoginPage::sgnalEnterMainPage(QString _t1, QString _t2, int _t3)
{
